...
const shapingFieldConfig = [
  ...
  { key: 'diameterOrSideLength', label: '直径/边长及公差（mm）', printLabel: '直径/边长', unit: 'mm' },
  { key: 'length', label: '长度及公差（mm）', printLabel: '长度', unit: 'mm' },
];
...
export const PROCESS_CATALOG: OperationDefinition[] = [
  {
    ...
    fieldConfig: [
      ...
      { key: 'count', label: '支数（支）', printLabel: '支数', unit: '支' },
      { key: 'specification', label: '规格' },
      { key: 'weight', label: '重量（kg）', printLabel: '重量', unit: 'kg' },
      { key: 'length', label: '长度及公差（mm）', printLabel: '长度', unit: 'mm' },
    ],
  ...
  },
  {
    ...
    detailLabel: '产品要求',
    fieldConfig: [
      { key: 'type', label: '类型', inputType: 'select', options: ['方坯', '圆坯', '扁坯'] },
      { key: 'diameter', label: '直径/边长及公差（mm）', printLabel: '直径/边长', unit: 'mm' },
      { key: 'length', label: '长度及公差（mm）', printLabel: '长度', unit: 'mm' },
    ],
  ...
  },
  {
    ...
    detailLabel: '产品要求',
    fieldConfig: [
      { key: 'diameter', label: '直径及公差（mm）', printLabel: '直径', unit: 'mm' },
      { key: 'length', label: '长度及公差（mm）', printLabel: '长度', unit: 'mm' },
  ...
  },
  {
    ...
    fieldConfig: [
      ...
      { key: 'lengthAndTolerance', label: '长度及公差（mm）', printLabel: '长度', unit: 'mm' },
      { key: 'widthAndTolerance', label: '宽度及公差（mm）', printLabel: '宽度', unit: 'mm' },
    ],
    optionCatalog: [],
  },
  {
  ...
  },
  {
    ...
    fieldConfig: [
      ...
      { key: 'diameterOrSideAndTolerance', label: '直径/边长及公差（mm）', printLabel: '直径/边长', unit: 'mm' },
  ...
  },
  {
    ...
    allowsMultipleDetails: false,
    detailLabel: '产品要求',
    fieldConfig: [{ key: 'length', label: '长度及公差（mm）', printLabel: '长度', unit: 'mm' }],
    optionCatalog: [],
  },
  {
    code: 'polishing',
    ...
    fieldConfig: [
      { key: 'diameter', label: '直径及公差（mm）', printLabel: '直径', unit: 'mm' },
      { key: 'roughness', label: '粗糙度（μm）', printLabel: '粗糙度', unit: 'μm' },
    ],
    optionCatalog: [],
  },
  {
  ...
  },
  {
    ...
    fieldConfig: [
      ...
      { key: 'diameter', label: '直径及公差（mm）', printLabel: '直径', unit: 'mm' },
      { key: 'roughness', label: '粗糙度≤（μm）', printLabel: '粗糙度≤', unit: 'μm' },
      { key: 'straightness', label: '直线度≤（mm/m）', printLabel: '直线度≤', unit: 'mm/m' },
    ],
    optionCatalog: [],
  },
  {
